...
def define_base(data_dir=True, model_dir=True, clean=True, train_epochs=True,
  ...
  if model_dir:
    flags.DEFINE_string(
        ...
        # default="/home/zxc/Liu/models-master-new/official/r1/resnet/model/new/",
  ...
  if train_epochs:
    flags.DEFINE_integer(
        name="train_epochs", short_name="te", default=20,
  ...
  if batch_size:
    flags.DEFINE_integer(
        name="batch_size", short_name="bs", default=52,
  ...
  if export_dir:
    flags.DEFINE_string(
        name="export_dir", short_name="ed",
        default="/home/zxc/Liu/models-master-new/official/r1/resnet/logs",
